  package com.ddit.hr.spring.config;
...
@Configuration
// 상위 컨테이너 생성 
@ComponentScan(basePackages = "com.ddit.hr"
	, excludeFilters = {
...
public class RootContextJavaConfig {
	...
	public PropertiesFactoryBean dbInfo(
		@Value("classpath:com/ddit/hr/db/DBInfo.properties") Resource location 
	) {
...
//Resource... mapperLocations
	...
	public SqlSessionFactoryBean sqlSessionFactory(
		...
		, @Value("classpath:com/ddit/hr/mybatis/Configuration.xml") Resource configLocation
		, @Value("classpath:com/ddit/hr/mybatis/mappers/*.xml") Resource...mapperLocations //가변형 파라미터
			) {
		...
		//사이에 ** -> vo로 끝나는 모든 패키지들
		factoryBean.setTypeAliasesPackage("com.ddit.hr.**.vo");
		return factoryBean;
	}
	...
	public MapperScannerConfigurer mapperScanner() {
		...
		configurar.setBasePackage("com.ddit.hr.mybatis.mappers");
