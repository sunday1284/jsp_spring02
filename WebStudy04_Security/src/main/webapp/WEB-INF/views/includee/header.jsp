	    ...
	    <nav class="header-nav ms-auto">
	      <ul class="d-flex align-items-center">
	        ...
	        <security:authorize access="isAuthenticated()">
	        	...
	        	<c:set value="${principal.realUser }" var="authMember"></c:set>
	        <li class="nav-item dropdown pe-3">
	          ...
	          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
	            ...
	            <span class="d-none d-md-block dropdown-toggle ps-2">${authMember.memName }</span>
	          </a><!-- End Profile Iamge Icon -->
	
	          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
	            <li class="dropdown-header">
	              <span>${authMember.memHp }</span>
	            </li>
	            <li>
	              <hr class="dropdown-divider">
	            </li>
	            ...
	            <li>
	              <a class="dropdown-item d-flex align-items-center" href="${pageContext.request.contextPath}/Login/Logout">
			...
			<security:authorize access="isAnonymous()">
				<li class="nav-item pe-3">
		          ...
		          <a class="nav-link nav-profile d-flex align-items-center pe-0" 
		          	href="<c:url value='/login/loginForm.jsp'/>" >
		            Sign In
		          </a><!-- End Profile Iamge Icon -->
		         </li>
		         <li class="nav-item pe-3">
		          ...
		          <a class="nav-link nav-profile d-flex align-items-center pe-0" 
		          	href="<c:url value='/member/memberInsert.do'/>" >
		            Sign Up
		          </a><!-- End Profile Iamge Icon -->
		         </li>
			</security:authorize>
